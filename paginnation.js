export default{
    ...
    <ul class="pagination">
        ...
        <li class="page-item" :class="{active:page === pages.current_page}" v-for="page in pages.total_pages" :key="page+123"><a class="page-link" href="#" @click="getProducts(page)">{{page}}</a></li>
